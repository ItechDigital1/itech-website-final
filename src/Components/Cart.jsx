...
import emptyCartImage from '../assets/images/img/empty-cart.png'; // Adjust the path based on your project structure

function Cart() {
  return (
    <div style={{ textAlign: 'center', marginTop: '50px' }}>
        <div>
    <div className='cart-items-empty text-xl font-bold mb-1'><h1>Oops Your Cart is Empty... 😕</h1> </div>
